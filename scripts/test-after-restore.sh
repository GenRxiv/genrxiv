...
sg docker -c "docker cp api/code_of_conduct.py $API_CONTAINER:/app/code_of_conduct.py"
sg docker -c "docker cp api/reconcile.py $API_CONTAINER:/app/reconcile.py"
