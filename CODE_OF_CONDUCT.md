...
GenRxiv is built on the idea that AI-generated research deserves the same
openness and scrutiny as any other research. That spirit extends to how we
treat each other in this project.

We pledge to make participation in GenRxiv a harassment-free experience for
...
This Code of Conduct applies within all GenRxiv community spaces, including
the GitHub repository, issues, pull requests, discussions, and any other
communication channels officially affiliated with the project.

It also applies when an individual is officially representing the community
in public spaces — for example, at conferences, on social media, or in
project documentation.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to **conduct@genrxiv.org**. All complaints will be reviewed and
